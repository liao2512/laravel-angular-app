                            ...
                            <table class="table table-hover table-striped">
                                ...
                                <tbody>
                                    <tr ng-repeat="course in courses | filter:searchTerm | orderBy:'position'">
                                        ...
                                        <td>
                                            <a ng-class="course.status == '1' ? 'btn btn-sm btn-fill btn-success' : 'btn btn-sm btn-fill btn-warning'" ng-click="updateStatus(course); (course.status == '1' ? course.status = '0' : course.status = '1')"><% course.name %></a>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <a class="btn btn-sm btn-info btn-fill" ng-href="/categories/<% category %>/courses/<% course.id %>/edit"><i class="fa fa-edit" aria-hidden="true"></i> Editar</a>
